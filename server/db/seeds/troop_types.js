...
const troops = [
  ...
  { race: 'human', tier: 3, name: 'Knight',         offense: 8,  defense: 3,  gold: 100,  food: 2, hours: 1/3600, special: '+10% plunder gold on raid', requires: null },
  { race: 'human', tier: 4, name: 'Arcane Archer',  offense: 7,  defense: 2,  gold: 450,  food: 3, hours: 1/3600, special: 'Bypasses 10% of enemy defense value', requires: 'war_hall:3' },
  { race: 'human', tier: 5, name: 'Royal Guard',    offense: 0,  defense: 18, gold: 800,  food: 4, hours: 1/3600, special: 'Defense only - cannot be sent on offense', requires: 'war_hall:5' },
  ...
  { race: 'orc', tier: 3, name: 'Warchief',         offense: 6,  defense: 5,  gold: 100,  food: 2, hours: 1/3600, special: '+5% to all attack units in same army', requires: null },
  { race: 'orc', tier: 4, name: 'Siege Breaker',    offense: 5,  defense: 2,  gold: 500,  food: 3, hours: 1/3600, special: 'Destroys one enemy building level on win', requires: 'war_hall:3' },
  { race: 'orc', tier: 5, name: 'Wyvern Rider',     offense: 14, defense: 4,  gold: 900,  food: 4, hours: 1/3600, special: 'Immune to non-ranged defenders', requires: 'war_hall:5' },
  ...
  { race: 'elf', tier: 3, name: 'Blade Dancer',     offense: 9,  defense: 5,  gold: 100,  food: 2, hours: 1/3600, special: 'Evades 15% of enemy counterattack casualties', requires: null },
  { race: 'elf', tier: 4, name: 'Treant',           offense: 0,  defense: 25, gold: 700,  food: 3, hours: 1/3600, special: 'Defense only; cannot attack', requires: 'war_hall:3' },
  { race: 'elf', tier: 5, name: 'Archmage',         offense: 22, defense: 3,  gold: 1400, food: 4, hours: 1/3600, special: 'Casts spell on attack reducing enemy DEF by 15%', requires: 'war_hall:5' },
  ...
  { race: 'dwarf', tier: 3, name: 'Runic Warrior',  offense: 7,  defense: 7,  gold: 100,  food: 2, hours: 1/3600, special: 'Gets +3 ATK/DEF per level of Runic Forge', requires: null },
  { race: 'dwarf', tier: 4, name: 'Ironclad',       offense: 9,  defense: 5,  gold: 650,  food: 3, hours: 1/3600, special: 'Destroys enemy wall effectiveness by 20% on win', requires: 'war_hall:3' },
  { race: 'dwarf', tier: 5, name: 'Siege Engineer', offense: 13, defense: 2,  gold: 1100, food: 4, hours: 1/3600, special: '+50% effectiveness vs fortified provinces', requires: 'war_hall:5' },
];
